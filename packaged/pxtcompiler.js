    ...
    (function (pxtc) {
        ...
        function jsEmit(bin) {
            ...
            if (bin.res.breakpoints)
                jssource += "\nsetupDebugger(" + bin.res.breakpoints.length + ", [" + bin.globals.filter(function (c) { return c.isUserVariable; }).map(function (c) { return "\"" + c.uniqueName() + "\""; }).join(",") + "])\n";
    ...
    (function (pxtc) {
        ...
        (function (decompiler) {
            ...
            function decompileToBlocks(blocksInfo, file, options, renameMap) {
                ...
                function checkConditionalExpression(expr) {
                    ...
                    function checkBooleanCallExpression(n) {
                        var callInfo = n.expression.callInfo;
                        if (callInfo) {
                            var type = callInfo.decl.type;
            ...
            function isDeclaredElsewhere(node) {
                return node.identifierInfo && node.identifierInfo.isGlobal;
            }
        ...
        (function (ir) {
            ...
            var Cell = /** @class */ (function () {
                function Cell(index, def, info) {
                    ...
                    this.bitSize = 0 /* None */;
                    if (def) {
                        var s = ts.getSourceFileOfNode(def);
                        if (s && s.fileName) {
    ...
    (function (pxtc) {
        ...
        (function (service_1) {
            ...
            var operations = {
                ...
                blocksInfo: function (v) { return blocksInfoOp(v, v.runtime.bannedCategories); },
                apiSearch: function (v) {
                    var SEARCH_RESULT_COUNT = 7;
                    var search = v.search;
                    var blockInfo = blocksInfoOp(search.localizedApis, v.runtime.bannedCategories); // caches
